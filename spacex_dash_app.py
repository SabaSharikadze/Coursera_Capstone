...
def get_pie_chart(entered_site):
    if entered_site == 'ALL' or entered_site == 'All':
        ...
        filtered_df = pd.DataFrame(df['class'].value_counts()).reset_index()
        fig=px.pie(filtered_df, values='class', names='index',
                   title='Total Success Lunches for Site {}'.format(entered_site))
        return fig
